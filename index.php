	  ...
	  <div class="row">
		...
		<h1 class="my-4" ></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
			  ...
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Seller</a>
			  ...
			  <a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false">Buyer</a>
		 ...
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent" style="background-color: #15acd6;">
					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <button type="button" id="addItem"  class="btn btn-outline-primary" style="border-radius: 15px">Add Item</button>
							  <button type="button" id="updateItemDetailsButton"  class="btn btn-outline-success" style="border-radius: 15px">Update</button>
							  <button type="button" id="deleteItem"  class="btn btn-outline-danger" style="border-radius: 15px">Delete</button>
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<form name="imageForm" id="imageForm" method="post">
							  ...
							  <br>
							  <button type="button" id="updateImageButton"  class="btn btn-outline-success" style="border-radius: 15px">Upload Image</button>
							  <button type="button" id="deleteImageButton" class="btn btn-outline-danger" style="border-radius: 15px">Delete Image</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <button type="button" id="addPurchase"  class="btn btn-outline-success" style="border-radius: 15px">Add Purchase</button>
					  <button type="button" id="updatePurchaseDetailsButton"  class="btn btn-outline-primary" style="border-radius: 15px"">Update</button>
					  <button type="reset" class="btn">Clear</button>
					</form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <button type="button" id="addVendor" name="addVendor"  class="btn btn-outline-success" style="border-radius: 15px">Add Vendor</button>
					  <button type="button" id="updateVendorDetailsButton"  class="btn btn-outline-primary" style="border-radius: 15px">Update</button>
					  <button type="button" id="deleteVendorButton"  class="btn btn-outline-danger" style="border-radius: 15px">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <button type="button" id="addSaleButton"  class="btn btn-outline-success" style="border-radius: 15px">Add Sale</button>
					  <button type="button" id="updateSaleDetailsButton"  class="btn btn-outline-primary" style="border-radius: 15px">Update</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <button type="button" id="addCustomer" name="addCustomer" class="btn btn-outline-success" style="border-radius: 15px">Add Customer</button>
					  <button type="button" id="updateCustomerDetailsButton"  class="btn btn-outline-primary" style="border-radius: 15px">Update</button>
					  <button type="button" id="deleteCustomerButton"  class="btn btn-outline-danger" style="border-radius: 15px">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Search Inventory<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-outline-primary float-right btn-sm" style="border-radius: 15px">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Reports<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-outline-primary float-right btn-sm" style="border-radius: 15px">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
